...
export const sampleReleases = [
  {
    ...
    features: [
      ...
      "Machines Integration: Supports ZKTeco, Hikvision & Conovy devices, with auto/manual fingerprint import.",
      "Scheduling & Tracking: Weekly shift scheduling, real-time mobile attendance updates.",
      "Requests & Leave: Enhanced excuse and overtime requests, bulk leave balance updates.",
  ...
  },
  {
    ...
    features: [
      ...
      "Scheduler: Auto-repeat last week's shift to future weeks.",
      "Tracking: Leave names, approved requests, mission/excuse hours, and source icons now shown; full check-in/out details recorded.",
      "Geo Attendance: Employees can view assigned shift details when checking in/out via mobile.",
      "Leave Management: New “Allow Negative Balance” option for leave requests.",
      "Requests: Admin/HR can now print requests.",
      "Enhancements: Improved ATS search and navigation.",
      "Enhancements: Better performance for copy shift/policy.",
      "Enhancements: Penalty requests now support decimals.",
  ...
  },
  {
    ...
    features: [
      ...
      "Transactions: One-time salary entries now allowed for resigned employees.",
      "Leave Setup: Control carryforward limits, reset dates, and leave request date ranges.",
      "Attendance Tracking: Filter by location/unit; smart map view; GEO names from Google Maps now shown.",
      "Release Notes: System now sends update announcements to Admin and HR users.",
      "Reports: User Audit",
      "Reports: Attendance Tracking",
      "Reports: Attendance Impact on Leave Balance",
      "Reports: Employee Requests History",
      "Enhancements: Middleware now supports mixed system setups (Win64 + Office32).",
      "Enhancements: Auto-import scheduler improved for multiple sources.",
  ...
  },
  {
    ...
    features: [
      ...
      "Applicant Loader: Bulk upload for applicant data to streamline onboarding.",
      "Requests: Loan Settlement",
      "Requests: Work from Home",
      "Requests: Leave Encashment",
      "Requests: Shift Change",
      "Request Management: Role-based visibility and control across web/mobile.",
      "Attendance Management: Flexible weekend setup (weekly, semi-monthly, monthly).",
      "Employee Uploaders: Bulk photo and line manager upload.",
      "Reports: Attendance Violations",
      "Reports: Attendance Impact on Leave",
      "Reports: Employee Request History",
      "Reports: User Audit",
      "Mobile App: Multi-user attendance control",
      "Mobile App: Version control enforcement",
      "Enhancements: Employee Group filters (Shift Type, Work Group)",
      "Enhancements: Targeted announcements by group",
      "Enhancements: Request filtering by date",
      "Enhancements: Geo location assignment in data uploader",

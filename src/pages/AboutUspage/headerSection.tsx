  ...
  return (
     <div className="w-full p-10 md:p-12 lg:p-16 bg-white">
      ...
      <div className="text-center mb-8">
        <h1 className="text-4xl font-bold text-gray-900 my-6 mb-2">ABOUT US</h1>
      ...
      <div className="prose prose-lg">
        <div className="space-y-6 text-gray-700 leading-relaxed">
          <p className="text-lg">
            <span className="font-bold text-2xl text-orange-500 mb-8">Dirac Systems:</span> <br/> is a leading Egyptian shareholder company
            specializing in advanced strategic business software solutions that drive digital transformation across
            various organizations. Established in <span className="font-medium text-orange-600">2012</span>, with a
            capital of <span className="font-medium text-orange-600">27 million EGP</span>, DIRAC has quickly positioned
          ...
          <p className="text-lg">
            ...
            <span className="font-medium text-orange-600">Enterprise Resource Planning (ERP)</span> solutions designed
          ...
          <p className="text-lg">
            ...
            <span className="font-medium text-orange-600">Fawry Business HR and Accounting systems</span>—DIRAC Systems
